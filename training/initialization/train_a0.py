...
if __name__ == "__main__":
    os.makedirs("models/initialization/a0_checkpoints", exist_ok=True)
    ...
    checkpoint_cb = CheckpointCallback(
        ...
        save_path = "models/initialization/a0_checkpoints/",
        name_prefix = "a0",
        verbose = 1,
    )
    ...
    monitor_cb = A0MonitorCallback(
        ...
        model_dir     = "models/initialization/",
        verbose       = 1,
    )

    log.info(f"[A0] Starting training — {N_ENVS} envs, up to {TOTAL_STEPS:,} steps")
    log.info(f"[A0] Checkpoints: models/initialization/a0_checkpoints/  |  Best: models/initialization/a0_best.zip")
    ...
    final_path = "models/initialization/a0_final"
